...
import { experienceData, TimelineEntry } from "@/data/experience"; 
...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => { 
  ...
  return (
    <div
      className="w-full bg-gray-50 dark:bg-gray-950 font-sans md:px-10" 
      ref={containerRef}
    >
...
const TimelineItem: React.FC<TimelineItemProps> = ({ item, index }) => {
  ...
  const cardEntryVariants = {
    ...
    visible: { opacity: 1, x: 0, transition: { duration: 0.8, ease: cubicBezier(0.0, 0.71, 0.2, 1.01) } },
  };
